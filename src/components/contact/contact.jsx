                    ...
                    <div className=" md:h-[30rem] w-[90%] sm:w-[80%] flex flex-col md:flex-row md:justify-between ">
                        {/* first div */}
                         <div className="md:h-[28rem] md:w-[48%] bg-slate-900 rounded-lg mt-3 text-white pb-5 px-3 sm:px-0">
                            ...
                            <p className="pl-2 pt-5  sm:pl-7 text-white/70" id="mgl"><i className="fa-regular fa-envelope text-xl"></i><span className="pl-2 md:pl-2 lg:pl-4">sharmanishant08751@gmail.com</span></p>
                        ...
                        <div className="h-[29rem] md:h-[28rem] md:w-[48%] bg-slate-900 rounded-lg mt-7 md:mt-3 flex justify-center items-center mb-5">
                           ...
                           <form action="" className="h-[100%]" ref={form} onSubmit={sendEmail}>
                            ...
                            <div className="h-[10%] bg-slate-700 rounded-md mt-1">
                                ...
                                <input type="text" placeholder="Enter your name" id="name" className="h-[100%] w-[90%] bg-slate-700 outline-none md:pl-2 lg:pl-0 rounded-md px-3" name='from_name' required />
                            </div>
                            ...
                            <div className="h-[10%] bg-slate-700 rounded-md mt-1">
                                ...
                                <input type="text" placeholder="Enter your email" id="email" className="h-[100%] w-[90%] bg-slate-700 outline-none md:pl-2 lg:pl-0 rounded-md px-3" name='to_email' required/>
                            </div>
                            ...
                            <div className="h-[30%] bg-slate-700 rounded-md mt-1 flex">
                                {/* <i className="fa-regular fa-envelope text-[1.2em] pl-2 w-[10%] text-white/60"></i> */}
                                <i className="fa-regular fa-comment text-[1.2em] pl-2 pt-4 w-[10%] text-white/60"></i>
                                ...
                                <textarea name="message" placeholder="Enter yoir message" id="message" className="h-[100%] w-[90%] bg-slate-700  md:pl-2 lg:pl-0 pt-3 pb-2 outline-none rounded-md px-3"  required></textarea>
                            </div>
