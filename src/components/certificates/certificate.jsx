            ...
            <div className=" bg-white dark:bg-slate-800" id='certificates'>
                ...
                <div className=" flex justify-center pb-10">
                    ...
                    <div className="h-[25rem]  sm:w-[55%]  flex justify-center gap-2 sm:gap-5 md:gap-10 items-center px-2" id='outerdiv'>
                            <div className="h-[2rem] w-[2rem] rounded-full dark:bg-slate-500 flex justify-center items-center" onClick={decrease}>
                            ...
                            <div className="h-[2rem] w-[2rem] rounded-full dark:bg-slate-500 flex justify-center items-center" onClick={increase}>
