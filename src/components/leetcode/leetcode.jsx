            ...
            <div className="md:h-screen xl:h-full xl:pb-10 bg-white dark:bg-slate-900" id='leetcode'>
                ...
                <div className="w-[100%] mt-5 flex flex-col items-center md:flex-row md:justify-around ">
                        ...
                        <div className="w-[80%] sm:w-[65%] md:w-[45%]  mt-10 mb-10 md:mb-0">
                            ...
                            <p className="text-black/70 dark:text-white/80 text-[1.1rem] text-center pt-9 pl-2 pr-2">
                            ...
                            <p className="text-black/70 dark:text-white/80  text-[1.1rem] text-center pt-6 pl-2 pr-2 pb-3">
