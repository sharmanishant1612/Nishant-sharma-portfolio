    ...
    return(
        ...
        <div className=" bg-slate-900 pt-3 flex flex-col items-center pb-10">
                <div className="mt-7 px-5 sm:px-8   flex justify-center flex-wrap ">
                    <a href="" className="text-gray-400   font-semibold py-1 px-3">Home</a>
                    <a href="" className="text-gray-400   font-semibold py-1 px-3">About</a>
                    <a href="" className="text-gray-400   font-semibold py-1 px-3">Skills</a>
                    <a href="" className="text-gray-400   font-semibold py-1 px-3">Projects</a>
                    <a href="" className="text-gray-400   font-semibold py-1 px-3">Leetcode</a>
                    <a href="" className="text-gray-400   font-semibold py-1 px-3">Badges</a>
                    <a href="" className="text-gray-400   font-semibold py-1 px-3">Certificates</a>
                    <a href="" className="text-gray-400   font-semibold py-1 px-3">Education</a>
                    <a href="" className="text-gray-400   font-semibold py-1 px-3">Contact</a>
                </div>
