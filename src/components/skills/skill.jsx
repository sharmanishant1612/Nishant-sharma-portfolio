        ...
        <div className=" bg-slate-900" id="skills">
                ...
                <div className=" w-[100%] flex justify-center items-center mt-8">
                        ...
                        <div className="w-[100%] sm:w-[75%] flex flex-wrap justify-evenly sm:justify-between pb-5">
                            ...
                            <div className='h-[60%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%]   bg-orange-200/15 rounded-full flex flex-row justify-center items-center'>
                            <img src={html} alt="" className='h-[90%] w-[80%] '/> 
                            </div>
                            ...
                            <a href="" className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300" id="anchor">
                             <div className='h-[60%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%]   bg-sky-600/15 rounded-full flex flex-row justify-center items-center '>
                            <img src={css} alt="" className='h-[80%] w-[80%] object-cover'/> 
                            </div>
                            <p className='text-white text-[1.2em] font-semibold'>CSS</p>
                            </a>

                            <a href="" className="h-[8.5rem] sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300" id="anchor">
                             <div className='h-[60%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%] bg-yellow-400/15 rounded-full flex flex-row justify-center items-center'>
                            <img src={javascriptt} alt="" className='sm:h-[70%] h-[90%] w-[80%] '/> 
                            </div>
                            <p className='text-white text-[1.2em] font-semibold'>JavaScript</p>
                            </a>

                            <a href="" className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300" id="anchor">
                            <div className='h-[60%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%] bg-cyan-600/15 rounded-full flex flex-row justify-center items-center'>
                            ...
                            <a href="" className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300" id="anchor">
                             <div className='h-[60%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%] bg-indigo-600/15 rounded-full flex flex-row justify-center items-center'>
                            ...
                            <a href="" className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300" id="anchor">
                            <div className='h-[60%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%]   bg-cyan-500/10 rounded-full flex flex-row justify-center items-center'>
                            ...
                            <a href="" className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300" id="anchor">
                             <div className='h-[60%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%] bg-violet-600/15 rounded-full flex flex-row justify-center items-center'>
                            ...
                            <a href="" className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300" id="anchor">
                             <div className='h-[60%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%] bg-green-500/15 rounded-full flex flex-row justify-center items-center'>
                            ...
                            <a href="" className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300" id="anchor">
                            <div className='h-[60%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%] bg-sky-500/15 rounded-full flex flex-row justify-center items-center'>
                            ...
                            <a href="" className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300" id="anchor">
                             <div className='h-[60%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%] bg-blue-500/15 rounded-full flex flex-row justify-center items-center'>
                            ...
                            <a href="" className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300" id="anchor">
                             <div className='h-[60%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%]   bg-blue-500/15 rounded-full flex flex-row justify-center items-center'>
                            <img src={vscode} alt="" className='h-[90%] w-[80%] '/> 
                            </div>
                            <p className='text-white text-[1.2em] font-semibold'>VS code</p>
                            </a>

                            <a href="" className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300" id="anchor">
                             <div className='h-[60%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%]   bg-orange-500/15 rounded-full flex flex-row justify-center items-center'>
                            ...
                            <a href="" className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300" id="anchor">
                             <div className='h-[60%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%]  rounded-full flex flex-row justify-center items-center'>
                            ...
                            <a href="" className="h-[8.5rem] sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300" id="anchor">
                             <div className='h-[60%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%] bg-indigo-500/15 rounded-full flex flex-row justify-center items-center'>
