            ...
            <div className=" bg-black/5 dark:bg-slate-900" id='education'>
                ...
                <div className=" flex flex-col items-center">
                        ...
                        <div className="w-[75%] mt-10 mb-10">
                            {/* first div */}
                        <div className=" pt-5 pb-5 w-[100%] border border-black/5 bg-black/15 dark:bg-slate-800 rounded-lg flex flex-col justify-center r hover:border-blue-500 transition-all duration-300">
                            <div className="h-  flex sm:items-center pl-6 text-white">
                                <div className="h-[3rem]  sm:w-[3rem] mt-2 sm:mt-0 bg-blue-400 dark:bg-blue-700 rounded-md flex justify-center items-center" id="fisrtdiv">
                                    <i className="fa-solid fa-graduation-cap text-[1.5em]"></i>
                                </div>
                                <div className="pl-5 pr-2">
                                    <p className="text-black dark:text-white text-[1.3em] font-semibold">B.Tech in Computer Science Engineering</p>
                                    <p className="text-blue-500 font-semibold text-[1.05em] mt-2 sm:mt-0">Dr. Kedar Nath Modi University, Rajasthan</p>
                                </div>
                            </div>
                            <div className=" mt-3 sm:flex pt-1 pl-20 sm:pl-24 text-black/70 dark:text-white/50">
                        ...
                        {/*second div  */}                    
                         <div className=" pt-5 pb-5 w-[100%] border border-black/5  bg-black/15 dark:bg-slate-800 rounded-lg flex flex-col justify-center h hover:border-blue-500 transition-all duration-300 ">
                            <div className="h-  flex sm:items-center pl-6 text-white">
                                <div className="h-[3rem]   sm:w-[3rem] mt-2 sm:mt-0 bg-blue-400 dark:bg-blue-700 rounded-md flex justify-center items-center" id='seconddiv'>
                                    <i className="fa-solid fa-graduation-cap text-[1.5em]"></i>
                                </div>
                                <div className="pl-5 pr-2">
                                    <p className="text-black dark:text-white text-[1.3em] font-semibold">Senior Secondary (XII)</p>
                         ...
                         <div className="h-[3rem] bg-blue-600 w-[.2rem] ml-[13%] sm:ml-16"></div>
                         {/* third div */}
                         <div className="pt-5 pb-5 w-[100%] border-[1px] border-white/5   bg-black/15 dark:bg-slate-800 rounded-lg flex flex-col justify-center  transition-all duration-300 hover:border-blue-500">
                            <div className="h-  flex sm:items-center pl-6 text-white">
                                <div className="h-[3rem]  w-[4rem] sm:w-[3rem] mt-2 sm:mt-0 bg-blue-400 dark:bg-blue-700 rounded-md flex justify-center items-center" id='thirddiv'>
                                    <i className="fa-solid fa-graduation-cap text-[1.5em]"></i>
                                </div>
                                <div className="pl-5 pr-2">
                                    <p className=" text-black dark:text-white text-[1.3em] font-semibold">Secondary (X)</p>
