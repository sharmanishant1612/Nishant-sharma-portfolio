                        ...
                        <div className="h-[29rem] md:h-[28rem] md:w-[48%] bg-slate-900 rounded-lg mt-3 flex justify-center items-center mb-5">
                           ...
                           <form action="" className="h-[100%]">
                            ...
                            <div className="h-[10%] bg-slate-700 rounded-md mt-1">
                                ...
                                <input type="text" placeholder="Enter your name" id="name" className="h-[100%] w-[90%] bg-slate-700 outline-none md:pl-2 lg:pl-0 rounded-md px-3" />
                            </div>
                            ...
                            <div className="h-[10%] bg-slate-700 rounded-md mt-1">
                                ...
                                <input type="text" placeholder="Enter your email" id="email" className="h-[100%] w-[90%] bg-slate-700 outline-none md:pl-2 lg:pl-0 rounded-md px-3" />
                            </div>
                            ...
                            <div className="h-[30%] bg-slate-700 rounded-md mt-1 flex">
                                ...
                                <textarea name="" placeholder="Enter yoir message" id="message" className="h-[100%] w-[90%] bg-slate-700  md:pl-2 lg:pl-0 pt-3 pb-2 outline-none rounded-md px-3"></textarea>
                            </div>
