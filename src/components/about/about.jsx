...
function About(){
    return(
        <>
        <div className="h flex flex-col items-center bg-slate-200 dark:bg-slate-950 text-white" id="about">
            <p className='text-[2.5em] font-bold text-violet-600 mt-14'>About Me</p>
            <p className='w-[75%] mt-8 text-[1.2em] text-black/70 dark:text-white/80 text-center'>Hey there! 👋 I'm <span className='text-blue-600 font-semibold'>Nishant Sharma</span>, a Full-Stack Developer and final-year Computer Science Engineering student. I love transforming ideas into scalable web applications and solving complex coding challenges. My journey in tech revolves around continuous learning, experimenting with new technologies, and building solutions that make an impact.</p>
            <div className='bg-blue-200/50 dark:bg-blue-600  mt-7 sm:text-[1.1em] p-2 w-fit max-w-[80%] min-w-[10rem] rounded-md text-center text-blue-600 dark:text-white/80'>🚀 I like to build Products and solve problems</div>

            <div className=' w-[100%] flex flex-col md:flex-row md:flex-wrap justify-around items-center  mt-10'>
                <div className=' w-[90%] md:w-[45%]  mt-5 rounded-lg bg-white dark:bg-slate-900 hover:-translate-y-2 duration-300 hover:shadow-[1px_1px_27px_-4px_rgb(37,_99,_235)]'>
                    {/* inner div */}
                    <div className='flex items-center mt-5 pl-5 '>
                        ...
                        <span className='text-[1.4em] pl-4 text-black dark:text-white/90 font-semibold'>Who I Am</span>
                    </div>
                    {/* list */}
                    <p className='mt-3 mb-5 pl-10 text-[1.1em] text-black/70 dark:text-white/50 '>
                ...
                <div className=' w-[90%] md:w-[45%] mt-5 rounded-lg bg-white dark:bg-slate-900 hover:-translate-y-2 duration-300 hover:shadow-[1px_1px_27px_-4px_rgb(109,_40,_217)]'>
                     {/* inner div */}
                     <div className='flex items-center mt-5 pl-5'>
                        ...
                        <span className='text-[1.4em] pl-4 text-black dark:text-white/90 font-semibold'>Who I Do</span>
                    </div>
                    {/* list */}
                    <p className='mt-3 mb-5 pl-10 text-[1.1em] text-black/70 dark:text-white/50'>
                ...
                <div className=' w-[90%] md:w-[45%] mt-5 md:mb-5  rounded-lg bg-white dark:bg-slate-900 hover:-translate-y-2 duration-300 hover:shadow-[1px_1px_27px_-4px_rgb(21,_128,_61)]'>
                     {/* inner div */}
                     <div className='flex items-center mt-5 pl-5 '>
                        ...
                        <span className='text-[1.4em] pl-4 text-black dark:text-white/90 font-semibold'>My Goals</span>
                ...
                <div className='w-[90%] md:w-[45%] mt-5 mb-10 md:mb-5 rounded-lg  bg-white dark:bg-slate-900 hover:-translate-y-2 duration-300 hover:shadow-[1px_1px_27px_-4px_rgb(249,_115,_22)]'>
                     {/* inner div */}
                     <div className='flex items-center mt-5 pl-5'>
                        ...
                        <span className='text-[1.4em] pl-4 text-black dark:text-white/90 font-semibold'>My Philosophy</span>
                    </div>
                    {/* list */}
                    <p className='mt-3 mb-5 pl-10 text-[1.1em] text-black/70 dark:text-white/50'>
