...
function Skill(){
    return(
        <>
        <div className=" bg-slate-900" id="skills">
                ...
                <div className=" w-[100%] flex justify-center items-center mt-8">
                        ...
                        <div className="w-[100%] sm:w-[75%] flex flex-wrap justify-evenly sm:justify-between pb-5 sm:mb-16">
                            ...
                            <a href="https://developer.mozilla.org/en-US/docs/Web/HTML" target='_blank' className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300 group  " id="anchor">
                            ...
                            <a href="https://developer.mozilla.org/en-US/docs/Web/CSS" target='_blank' className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300 group" id="anchor">
                            ...
                            <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript" target='_blank' className="h-[8.5rem] sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300 group" id="anchor">
                            ...
                            <a href="https://react.dev/" target='_blank' className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300 group" id="anchor">
                            ...
                            <a href="https://getbootstrap.com/" target='_blank' className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300 group" id="anchor">
                            ...
                            <a href="https://tailwindcss.com/" target='_blank' className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300 group" id="anchor">
                            ...
                            <a href="https://www.w3schools.com/sql/" target='_blank' className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300 group" id="anchor">
                            ...
                            <a href="https://www.w3schools.com/cpp/" target='_blank' className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300 group" id="anchor">
                            ...
                            <a href="https://code.visualstudio.com/" target='_blank' className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300 group" id="anchor">
                             <div className='h-[50%] w-[55%] sm:h-[55%] sm:w-[65%] lg:h-[65%] md:w-[55%]   bg-blue-500/15 rounded-full flex flex-row justify-center items-center'>
                            ...
                            <a href="https://git-scm.com/" target='_blank' className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300 group" id="anchor">
                            ...
                            <a href="https://github.com/" target='_blank' className="h-[8.5rem]  sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300 group" id="anchor">
                            ...
                            <a href="https://vite.dev/" target='_blank' className="h-[8.5rem] sm:w-[20%] md:w-[18%]  lg:w-[15%] bg-slate-800 rounded-lg mt-5 ml-2 mr-2 flex flex-col justify-evenly items-center hover:transform hover:-translate-y-2 duration-300 group" id="anchor">
                            ...
                            <p className='text-white text-[1.2em] font-semibold'>Vite</p>
                            </a>
